...
const internal::Surface::Listener WlSurface::kSurfaceListener{
    .Enter =
        [](void *data, internal::Surface *surface, internal::Output *output) {
...
WlSurface::WlSurface(internal::Surface *handle) : handle_(handle) {
  ...
  handle_->AddListener(kSurfaceListener, this);
}
